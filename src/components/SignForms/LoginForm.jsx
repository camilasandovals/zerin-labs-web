...
export default function SignUpForm({isVisibleLogin, setIsVisibleLogin, isVisibleSignUp, setIsVisibleSignUp}) {
    ...
    const handleGetUser = async(e) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_APIENDPOINT}/api/users/login`, {
              method: "POST",
              headers: {
    ...
    return(
        <>
            <button className="button-landing" variant="primary" type="submit" style={{ position: 'absolute', top: '70%', left: '30%', transform: 'translate(-50%, -50%)' }} onClick={setVisibility}>Login</button>
